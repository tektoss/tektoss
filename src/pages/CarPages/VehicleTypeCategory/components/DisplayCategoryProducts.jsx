...
export default function DisplayCategoryProducts() {
  ...
  const {
    updateTime: time, maxPrice, minPrice, condition, make, model, minYear, maxYear,
  ...
  console.log('what type is gotten', vehicleType);
  ...
  useEffect(() => {
    const filterData = async () => {
      try {
        ...
        && (item.model === model || model === 'all')
        && (item.make === make || item.make === 'all')
