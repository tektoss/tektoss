...
export default function AddToWishListButton({
  userIsAnonymous, vendor, uid, id, make, model, year,
}) {
  ...
  const handleAddProductToWishList = async () => {
    ...
    if (itemExists) {
      errorToast(`${year} ${make} ${model} item has already been added`);
      return null;
    }
    ...
    successToast(`${year} ${make} ${model} has been added to wishlist`);
    return null;
  };
