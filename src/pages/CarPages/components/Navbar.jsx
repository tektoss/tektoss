...
import SellCarNowButton from './SellCarNowButton';
      ...
      <nav id="page-top" className={toggleDrawer ? 'navbar-custom toggled' : 'navbar-custom'}>
        ...
        <div className="navbar-custom__bottom-div">
          ...
          <ul style={{ display: 'flex', listStyle: 'none', padding: 0 }}>
            <li style={{ marginRight: '20px' }}>
              <button name="Electronics" onClick={() => handleCatPopOverClick("Electronics")} role="button">
                <h6>Electronics</h6>
              </button>
              console.log('where are you going')
            </li>
            <li style={{ marginRight: '20px' }}>
              <button name="Vehicles" onClick={() => handleCatPopOverClick("Vehicles")} role="button">
                <h6>Vehicles</h6>
              </button>
            </li>
          </ul>
