    ...
    <div>
      ...
      <div className="faq-container">
        ...
        <div className="faq-item">
          ...
          <p>
            While we prioritize safety, itapos; s important to take precautions. Always meet in public places during daylight hours, bring a friend if possible, and verify the identity of the other party.
        ...
        <div className="faq-item">
          ...
          <p>
            If you encounter any suspicious behavior, please report it immediately through our platform.
            Our support team will investigate the issue promptly. Your safety is our top priority.
          </p>
        </div>
        <div className="faq-item">
          <h3>
          ...
          <p>
            In the event that the received item does not match the description, contact our support team within 10am to 5pm (Mon-Friday). We will assist you in resolving the issue, which may include initiating a return or refund process.
          </p>
        </div>
        <div className="faq-item">
          <h3>
          ...
          <p>
            Utilize our secure messaging system to communicate with the other party before the meeting. Avoid sharing personal contact information until the meeting details are confirmed.
          </p>
        </div>
        <div className="faq-item">
          <h3>
          ...
          <p>
            Share a detailed description of the item, agree on a meeting location, and confirm the preferred method of contact.
            Avoid sharing personal information, such as home addresses or phone numbers, until you are comfortable.
          </p>
        </div>
        <div className="faq-item">
          <h3>
          ...
          <p>
            Log in to your account, go to your listings, and you&apos; ll find options to edit or delete each listing.
            Make sure to update your listing promptly if the item is sold or is no longer available.
          </p>
        </div>
        ...
        <div className="faq-item">
          ...
          <p>
            Currently, our platform is free to use. There are no listing fees or transaction fees. Any changes to our fee structure will be communicated to users in advance.
            We only charge a small fees for the promotion of items, for upgrading profile to a store.
          </p>
        </div>
      </div>
