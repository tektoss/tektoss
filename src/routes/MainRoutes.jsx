...
import SingleItem from '../pages/Electronics/SingleItem/SingleItem';
import '../styles/main.css';
import ChatRoom from '../pages/ChatRoom/ChatRoom';
import SearchResult from '../pages/Electronics/SearchResult/SearchResult';
import UserAccount from '../pages/UserAccount/UserAccount';
import NewItem from '../pages/Electronics/NewItem/NewItem';
import WishList from '../pages/WishList/WishList';
import Notifications from '../pages/Electronics/Notifications/Notifications';
import Category from '../pages/Electronics/Category/Category';
...
import EditItem from '../pages/Electronics/EditItem/EditItem';
